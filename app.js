...
const SCHEMA = {
  theme: {
    ...
    champs: [
      ...
      { cle: "promesse_chaine", type: "bloc", libelle: "Promesse de la chaîne",
        aide: "Ce à quoi on s'abonne, en une phrase. Chaque appel à s'abonner en tire sa raison — la vidéo mesurée avait 20 j'aime et zéro abonné." },
      { cle: "visuels.archives", type: "bool", libelle: "Images d'archive",
        aide: "Peintures, gravures et photos d'époque du VRAI sujet (Wikimedia Commons). Éteint, la vidéo n'est illustrée que par du stock d'ambiance." },
  ...
  reglages: {
    ...
    champs: [
      ...
      { cle: "titre_ecran.actif", type: "bool", libelle: "Titre en gros à l'ouverture",
